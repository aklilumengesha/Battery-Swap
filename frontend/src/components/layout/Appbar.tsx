  ...
  return (
    <Link href={route} className="flex-1 flex justify-center">
      <div className="relative flex flex-col items-center justify-center cursor-pointer py-2 px-4 group">
        {/* Active indicator - animated background with smoother transitions */}
        <div
        ...
        {/* Icon container with enhanced scale animation */}
        <div
        ...
        {/* Label with smoother fade animation */}
        <p
          className={`relative z-10 text-xs mt-1.5 font-medium transition-all duration-500 ease-in-out ${
            isActive
        ...
        {/* Active dot indicator with smoother animation */}
        <div
          className={`absolute -top-1 w-1 h-1 rounded-full bg-primary transition-all duration-500 ease-in-out ${
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 pointer-events-none">
      <div className="max-w-md mx-auto pointer-events-auto">
        {/* Enhanced glassmorphism container with scroll-based tint */}
        <div 
          className={`glass-nav-enhanced relative flex items-center justify-around px-2 py-1.5 rounded-3xl overflow-hidden border shadow-nav transition-all duration-500 ${
            isScrolled 
