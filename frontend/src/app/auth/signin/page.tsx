    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1617788138017-80ad40651399?w=1920&q=80')",
          }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-black/50 flex items-center justify-center">
            <div className="text-white px-12 max-w-xl">
              <h1 className="text-5xl font-bold mb-4 text-white drop-shadow-lg">Welcome Back</h1>
              <p className="text-xl text-white/90 drop-shadow-md">
                Sign in to access your battery swap network and manage your electric vehicle charging needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-all">
